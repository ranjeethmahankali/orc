...
void test_list_item_combinations(void)
{
  ...
  REQUIRE(ORC_ERROR_NONE == orc_sdk_deck_free(&lists));
  REQUIRE(ORC_ERROR_NONE == orc_sdk_deck_free(&indices));
  REQUIRE(ORC_ERROR_NONE == orc_sdk_deck_free(&out_items));
}
...
void test_add_f64_combinations(void)
{
  ...
  REQUIRE(ORC_ERROR_NONE == orc_sdk_deck_free(&a));
  REQUIRE(ORC_ERROR_NONE == orc_sdk_deck_free(&b));
  REQUIRE(ORC_ERROR_NONE == orc_sdk_deck_free(&out));
}
...
void test_list_length_combinations(void)
{
  ...
  REQUIRE(ORC_ERROR_NONE == orc_sdk_deck_free(&in));
  REQUIRE(ORC_ERROR_NONE == orc_sdk_deck_free(&out));
}
...
void test_two_output_combinations(void)
{
  ...
  REQUIRE(ORC_ERROR_NONE == orc_sdk_deck_free(&in_a));
  REQUIRE(ORC_ERROR_NONE == orc_sdk_deck_free(&in_b));
  REQUIRE(ORC_ERROR_NONE == orc_sdk_deck_free(&out1));
  REQUIRE(ORC_ERROR_NONE == orc_sdk_deck_free(&out2));
}
